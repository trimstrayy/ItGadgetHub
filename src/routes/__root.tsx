...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "IT Gadget Hub Banepa" },
      { property: "og:title", content: "IT Gadget Hub Banepa — Premium Tech Boutique" },
      { property: "og:description", content: "Curated premium tech in Banepa. Laptops, components, mobiles & accessories." },
